...
func (gaq *GoogleAuthQuery) GroupBy(field string, fields ...string) *GoogleAuthGroupBy {
	grbuild := &GoogleAuthGroupBy{config: gaq.config}
...
func (gaq *GoogleAuthQuery) Select(fields ...string) *GoogleAuthSelect {
	...
	selbuild := &GoogleAuthSelect{GoogleAuthQuery: gaq}
	selbuild.label = googleauth.Label
...
func (gaq *GoogleAuthQuery) sqlExist(ctx context.Context) (bool, error) {
...
func (gagb *GoogleAuthGroupBy) sqlScan(ctx context.Context, v any) error {
...
func (gagb *GoogleAuthGroupBy) sqlQuery() *sql.Selector {
...
func (gas *GoogleAuthSelect) Scan(ctx context.Context, v any) error {
	...
	gas.sql = gas.GoogleAuthQuery.sqlQuery(ctx)
	return gas.sqlScan(ctx, v)
}

func (gas *GoogleAuthSelect) sqlScan(ctx context.Context, v any) error {
