...
func (lsu *LoginSessionsUpdate) Save(ctx context.Context) (int, error) {
	return withHooks[int, LoginSessionsMutation](ctx, lsu.sqlSave, lsu.mutation, lsu.hooks)
}
...
func (lsuo *LoginSessionsUpdateOne) Save(ctx context.Context) (*LoginSessions, error) {
	return withHooks[*LoginSessions, LoginSessionsMutation](ctx, lsuo.sqlSave, lsuo.mutation, lsuo.hooks)
}
